...
Dialog::Dialog(QWidget *parent) :QDialog(parent), ui(new Ui::Dialog)
{
    ...
    connect(_serv, SIGNAL(ononAddUserToGui(QString*)), this, SLOT(onAddUserToGui(QString*)));
    connect(_serv, SIGNAL(ononRemoveUserFromGui(QString)), this, SLOT(onRemoveUserFromGui(QString)));
