...
void MyServer::incomingConnection(qintptr handle)
{
    ...
    */
    ...
    connect(client, SIGNAL(removeUserFromGui(QString)), this, SIGNAL(ononRemoveUserFromGui(QString)));
    connect(client, SIGNAL(addUserToGui(QString*)), this, SIGNAL(ononAddUserToGui(QString*)));
